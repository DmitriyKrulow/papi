...
def print('About to call register_routers()'); register_routers(); print('register_routers() called'):
...
print('About to call register_routers()'); register_routers(); print('register_routers() called')